/** @type {HTMLCanvasElement} */
  ...
  class Explosion {
    constructor(x, y, size) {
      ...
      this.sound.src = "assets/audio/fire-boom.wav";
    ...
    update(deltaTime) {
      try{
        // this will not work if in case of movement like mousemove.
  ...
  class Particle {
    constructor(x, y, size, color) {
      this.size = size;
      this.x = x + this.size * 0.5 + Math.random() * 10 - 5;
      this.y = y + this.size * 0.3 + Math.random() * 10 - 5;
